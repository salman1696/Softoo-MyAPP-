...
import Products from '../src/screens/BottomTab/Products';
...
test('renders product list correctly', () => {
    ...
    const { getByText } = render(<Products navigation={undefined} route={undefined} />);

    // Assert that all product names are rendered correctly
    expect(getByText('Product 1')).toBeTruthy();
    expect(getByText('Product 2')).toBeTruthy();
    expect(getByText('Product 3')).toBeTruthy();

    // You can add more assertions for prices or any other relevant information
});
